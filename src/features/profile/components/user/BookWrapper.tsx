...
function BookWrapper({ type }: BookWrapperProps) {
	...
	return (
		<div className='flex w-full flex-col items-start gap-y-[25px] rounded-[25px] bg-white px-[50px] py-[45px]'>
			<div className='flex flex-col items-start'>
				<h1 className='font-cormorant_sc_semibold text-[36px] font-semibold text-black'>
					{title}
				</h1>
